...
namespace SQLfuncs
{
    ...
    public class StringFunctions
    {
        ...
        // кодирование : привет ->  %D0%BF%D1%80%D0%B8%D0%B2%D0%B5%D1%82    
        [Microsoft.SqlServer.Server.SqlFunction(DataAccess = DataAccessKind.Read)]
        public static SqlString URLEncode(SqlString source)
        {
            var res = "";
        ...
        // декодирование : %D0%BF%D1%80%D0%B8%D0%B2%D0%B5%D1%82 -> привет     
        [Microsoft.SqlServer.Server.SqlFunction(DataAccess = DataAccessKind.Read)]
        public static SqlString URLDecode(SqlString source)
        {
            var res = "";
            if (source.IsNull == true) { return res; }
            var srcStr = source.Value;
